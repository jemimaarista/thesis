...
library(forecast)
library(readxl)
data <- read_excel("D:/A.Tugas Akhir/BAB 4/SBY/DNN/DATA DNN IS.xlsx", 
                   sheet = "TOTAL")
datat<-as.ts(data)
...
for (k in seq_along(neuron[,1]))
{
  ...
  mypath<-file.path("D:/A.Tugas Akhir/BAB 4/SBY/DNN/PLOT/TOTAL IS", paste("Total IS",(k),".jpg",sep=""))
  png(file=mypath)
  plot(best.model,rep="best")
  dev.off()
...
write.csv(akurasi,"D:/A.Tugas Akhir/BAB 4/SBY/DNN/OUTPUT/Total_IS_Akurasi.csv")
write.csv(fitsmodel,"D:/A.Tugas Akhir/BAB 4/SBY/DNN/OUTPUT/Total_IS_Fits.csv")
write.csv(foremodel,"D:/A.Tugas Akhir/BAB 4/SBY/DNN/OUTPUT/Total_IS_Fore.csv")
saveRDS(koefisien,file = "D:/A.Tugas Akhir/BAB 4/SBY/DNN/KOEF/Total_IS_Koef.rds")
